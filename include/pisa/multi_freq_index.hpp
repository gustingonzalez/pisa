...
class multi_freq_index {
   public:
    multi_freq_index() : m_size(0) {}
    ...
    class builder {
       public:
        ...
        auto add_posting_list(uint64_t n,
        ...
        void build(multi_freq_index &sq)
        {
    ...
    /* Allows read posting with index accessing, e.g. collection[0] */
    auto operator[](size_t i) const
    {
        ...
        return typename posting_list<Profile>::document_enumerator(
    ...
    void swap(multi_freq_index &other)
    {

...
void test_block_posting_list(bool adjust_to_block_size = false)
{
...
template <typename BlockCodec>
void test_block_posting_list_reordering(bool adjust_to_block_size = false)
{
    typedef pisa::block_posting_list<BlockCodec> posting_list_type;
    uint64_t universe = 20000;
    for (size_t t = 0; t < 20; ++t) {
...
{
    test_block_posting_list_reordering<pisa::optpfor_block>(true);
}
